...
DEFAULT_FILE_STORAGE = "ian_cms.settings.dgo.utils.MediaRootS3BotoStorage"

STATICFILES_STORAGE = "ian_cms.settings.dgo.utils.StaticRootS3BotoStorage"
...
PRIVATE_FILE_STORAGE = "ian_cms.settings.dgo.utils.MediaRootS3BotoStorage"
